...
export const INTRO_MESSAGES = {
  intro1: `You wake up dazed and confused. The room you are in is cold, dark, and eerily quiet. Your gut is telling you that something is very wrong. 
  You stand up to look around and realize that you are in a house you do not recognize, and you have no idea how you ended up here.
  You hear a muffled scream in the distance.`,
  intro2: `You feel the gentle pressure of something poking in your back. Inside your backpack, you find a laptop. 
  Based on the logo on the cover, it seems to be a company-issued work laptop...
  You power it on. The soft glow illuminates the room as an application opens. It looks to be a in-house chatbot assistant. It might be helpful in figuring out
  who you are, where you are, and how to get out of this damn place.
    
  You may query the chatbot from now on (Feature not yet implemented)`,
};
